...
namespace ORMCompare.Services.Repositories
{
    public class EmployeeTitleRepository : IEmployeeTitleRepository
    {
        ...
        {
            employeeTitleRepository.InsertRandom(procedureName, number);
        }
        public void DeleteRange(string procedureName, int number)
        {
            employeeTitleRepository.DeleteRange(procedureName, number);
        }
        public EmployeeTitle GetFirst()
        {
            return employeeTitleRepository.GetFirst();
        }
    }
}
